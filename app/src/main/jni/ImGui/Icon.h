...
/**
 * Icon.h - FontAwesome 5 Pro + FontAwesome 6 Combined Header
 *
 * Original FA5 by SPraditya (foxcheatsid@gmail.com)
 * FA6 extension: expanded glyph range + new icon defines
 *
 * FontAwesome 5 Pro  : range U+E000 - U+F8FF  (prefix ICON_FA_)
 * FontAwesome 6 Free : range U+E000 - U+FFFF  (prefix ICON_FA6_)
 *
 * Usage in ImGui (load both fonts if needed):
 *   // FA5 font
 *   static const ImWchar fa5_ranges[] = { ICON_MIN_FA,  ICON_MAX_FA,  0 };
 *   io.Fonts->AddFontFromMemoryTTF(fa5_data, fa5_size, size, &cfg, fa5_ranges);
 *
 *   // FA6 font (separate merge)
 *   static const ImWchar fa6_ranges[] = { ICON_MIN_FA6, ICON_MAX_FA6, 0 };
 *   io.Fonts->AddFontFromMemoryTTF(fa6_data, fa6_size, size, &cfg, fa6_ranges);
 */

// ─── FontAwesome 5 Pro Font File Names ────────────────────────────────────────
#define FONT_ICON_FILE_NAME_FAL  "fa-light-300.ttf"
#define FONT_ICON_FILE_NAME_FAR  "fa-regular-400.ttf"
#define FONT_ICON_FILE_NAME_FAS  "fa-solid-900.ttf"

// ─── FontAwesome 6 Font File Names ────────────────────────────────────────────
#define FONT_ICON_FILE_NAME_FA6_SOLID    "Font Awesome 6 Free-Solid-900.otf"
#define FONT_ICON_FILE_NAME_FA6_REGULAR  "Font Awesome 6 Free-Regular-400.otf"
#define FONT_ICON_FILE_NAME_FA6_BRANDS   "Font Awesome 6 Brands-Regular-400.otf"
// Pro variants (if licensed):
#define FONT_ICON_FILE_NAME_FA6PRO_SOLID "Font Awesome 6 Pro-Solid-900.otf"
#define FONT_ICON_FILE_NAME_FA6PRO_LIGHT "Font Awesome 6 Pro-Light-300.otf"
#define FONT_ICON_FILE_NAME_FA6PRO_THIN  "Font Awesome 6 Pro-Thin-100.otf"

// ─── FA5 Glyph Range ──────────────────────────────────────────────────────────
#define ICON_MIN_FA   0xe000
#define ICON_MAX_FA   0xf8ff

// ─── FA6 Glyph Range (expanded to cover all private use + standard) ───────────
#define ICON_MIN_FA6  0xe000
#define ICON_MAX_FA6  0xffff

// ─── Convenience: full range covering both FA5 and FA6 ────────────────────────
#define ICON_MIN_FA_ALL   0xe000
#define ICON_MAX_FA_ALL   0xffff


// ═══════════════════════════════════════════════════════════════════════════════
// SECTION 1: FontAwesome 5 Pro Icons (prefix: ICON_FA_)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// SECTION 2: FontAwesome 6 Icons (prefix: ICON_FA6_)
//
// These icons require loading a FA6 font file.
// Many codepoints overlap with FA5 but map to DIFFERENT glyphs.
// Always use a separate ImGui font merge pass for FA6:
//
//   ImFontConfig cfg;
//   cfg.MergeMode = true;
//   cfg.GlyphMinAdvanceX = iconSize;
//   static const ImWchar fa6_ranges[] = { ICON_MIN_FA6, ICON_MAX_FA6, 0 };
//   io.Fonts->AddFontFromFileTTF(FONT_ICON_FILE_NAME_FA6_SOLID, iconSize, &cfg, fa6_ranges);
// ═══════════════════════════════════════════════════════════════════════════════
#define ICON_FA6_PERSON "\xee\x85\xa0"	// U+e160
#define ICON_FA6_PERSON_DRESS "\xee\x85\xa7"	// U+e167
#define ICON_FA6_PERSON_BIKING "\xee\x87\x98"	// U+e1d8
#define ICON_FA6_PERSON_DIGGING "\xee\x87\xa3"	// U+e1e3
#define ICON_FA6_PERSON_DOTS_FROM_LINE "\xee\x8c\xb9"	// U+e339
#define ICON_FA6_PERSON_DROWNING "\xee\x8c\xbb"	// U+e33b
#define ICON_FA6_PERSON_FALLING "\xee\x86\x87"	// U+e187
#define ICON_FA6_PERSON_FALLING_BURST "\xee\x86\x88"	// U+e188
#define ICON_FA6_PERSON_HALF_DRESS "\xee\x95\x88"	// U+e548
#define ICON_FA6_PERSON_HARASSING "\xee\x95\x89"	// U+e549
#define ICON_FA6_PERSON_HIKING "\xee\x87\xa4"	// U+e1e4
#define ICON_FA6_PERSON_MILITARY_POINTING "\xee\x95\x8a"	// U+e54a
#define ICON_FA6_PERSON_MILITARY_RIFLE "\xee\x95\x8b"	// U+e54b
#define ICON_FA6_PERSON_MILITARY_TO_PERSON "\xee\x95\x8c"	// U+e54c
#define ICON_FA6_PERSON_PRAYING "\xee\x95\x8d"	// U+e54d
#define ICON_FA6_PERSON_PREGNANT "\xee\x8c\x9e"	// U+e31e
#define ICON_FA6_PERSON_RAYS "\xee\x95\x8e"	// U+e54e
#define ICON_FA6_PERSON_RIFLE "\xee\x95\x8f"	// U+e54f
#define ICON_FA6_PERSON_RUNNING "\xee\x8d\xb2"	// U+e372
#define ICON_FA6_PERSON_SHELTER "\xee\x95\x90"	// U+e550
#define ICON_FA6_PERSON_SKATING "\xee\x87\xb0"	// U+e1f0
#define ICON_FA6_PERSON_SKIING "\xee\x87\xb4"	// U+e1f4
#define ICON_FA6_PERSON_SKIING_NORDIC "\xee\x87\xb5"	// U+e1f5
#define ICON_FA6_PERSON_SNOWBOARDING "\xee\x87\xb7"	// U+e1f7
#define ICON_FA6_PERSON_SWIMMING "\xee\x8e\xa2"	// U+e3a2
#define ICON_FA6_PERSON_THROUGH_WINDOW "\xee\x96\xa3"	// U+e5a3
#define ICON_FA6_PERSON_WALKING "\xee\x8e\xa3"	// U+e3a3
#define ICON_FA6_PERSON_WALKING_ARROW_LOOP_LEFT "\xee\x95\x91"	// U+e551
#define ICON_FA6_PERSON_WALKING_ARROW_RIGHT "\xee\x95\x92"	// U+e552
#define ICON_FA6_PERSON_WALKING_DASHED_LINE_ARROW_RIGHT "\xee\x95\x93"	// U+e553
#define ICON_FA6_PERSON_WALKING_LUGGAGE "\xee\x95\x94"	// U+e554
#define ICON_FA6_PERSON_WALKING_WITH_CANE "\xee\x8c\xbe"	// U+e33e
#define ICON_FA6_FISHING_ROD "\xee\x8e\xa8"	// U+e3a8
#define ICON_FA6_TENT "\xee\x91\x8b"	// U+e44b
#define ICON_FA6_TENTS "\xee\x96\x80"	// U+e580
#define ICON_FA6_CAMPGROUND "\xef\x9a\xbb"	// U+f6bb
#define ICON_FA6_HEAD_SIDE_COUGH "\xee\x81\xa1"	// U+e061
#define ICON_FA6_HEAD_SIDE_COUGH_SLASH "\xee\x81\xa2"	// U+e062
#define ICON_FA6_HEAD_SIDE_MASK "\xee\x81\xa3"	// U+e063
#define ICON_FA6_HEAD_SIDE_VIRUS "\xee\x81\xa4"	// U+e064
#define ICON_FA6_HANDS_BUBBLES "\xee\x81\x9e"	// U+e05e
#define ICON_FA6_HAND_DOTS "\xee\x87\x9e"	// U+e1de
#define ICON_FA6_HAND_BACK_FIST "\xee\x87\x9e"	// U+e1de
#define ICON_FA6_VIRUS_COVID "\xee\x92\xa8"	// U+e4a8
#define ICON_FA6_VIRUS_COVID_SLASH "\xee\x92\xa9"	// U+e4a9
#define ICON_FA6_WHEELCHAIR_MOVE "\xee\x93\x89"	// U+e4c9
#define ICON_FA6_GUN "\xee\x86\x9b"	// U+e19b
#define ICON_FA6_BOMB "\xef\x87\xa2"	// U+f1e2
#define ICON_FA6_LAND_MINE_ON "\xee\x94\x9b"	// U+e51b
#define ICON_FA6_HAND_HOLDING_HAND "\xee\x93\xb7"	// U+e4f7
#define ICON_FA6_EARTH_AFRICA "\xee\x93\x8a"	// U+e4ca
#define ICON_FA6_EARTH_AMERICAS "\xee\x93\x8b"	// U+e4cb
#define ICON_FA6_EARTH_ASIA "\xee\x93\x8c"	// U+e4cc
#define ICON_FA6_EARTH_EUROPE "\xee\x93\x8d"	// U+e4cd
#define ICON_FA6_EARTH_OCEANIA "\xee\x93\x8e"	// U+e4ce
#define ICON_FA6_SOLAR_PANEL "\xef\x96\xba"	// U+f5ba
#define ICON_FA6_WIND "\xef\x9c\xae"	// U+f72e
#define ICON_FA6_SEEDLING "\xef\x93\x98"	// U+f4d8
#define ICON_FA6_LEAF "\xef\x81\xac"	// U+f06c
#define ICON_FA6_ARROW_ROTATE_LEFT "\xef\x83\xa2"	// U+f0e2
#define ICON_FA6_ARROW_ROTATE_RIGHT "\xef\x80\x9e"	// U+f01e
#define ICON_FA6_ARROWS_SPIN "\xee\x92\xbb"	// U+e4bb
#define ICON_FA6_ARROWS_TO_CIRCLE "\xee\x92\xbc"	// U+e4bc
#define ICON_FA6_ARROWS_TO_DOT "\xee\x92\xbe"	// U+e4be
#define ICON_FA6_ARROWS_TO_EYE "\xee\x92\xbf"	// U+e4bf
#define ICON_FA6_ARROW_TREND_DOWN "\xee\x82\x97"	// U+e097
#define ICON_FA6_ARROW_TREND_UP "\xee\x82\x98"	// U+e098
#define ICON_FA6_ARROW_UP_FROM_BRACKET "\xee\x82\x9d"	// U+e09d
#define ICON_FA6_ARROW_UP_FROM_GROUND_WATER "\xee\x92\xb5"	// U+e4b5
#define ICON_FA6_ARROW_UP_RIGHT_DOTS "\xee\x92\xb7"	// U+e4b7
#define ICON_FA6_ARROW_UP_WIDE_SHORT "\xef\x85\xa1"	// U+f161
#define ICON_FA6_BUILDING_CIRCLE_ARROW_RIGHT "\xee\x93\x91"	// U+e4d1
#define ICON_FA6_BUILDING_CIRCLE_CHECK "\xee\x93\x92"	// U+e4d2
#define ICON_FA6_BUILDING_CIRCLE_EXCLAMATION "\xee\x93\x93"	// U+e4d3
#define ICON_FA6_BUILDING_CIRCLE_XMARK "\xee\x93\x94"	// U+e4d4
#define ICON_FA6_BUILDING_COLUMNS "\xef\x86\x9c"	// U+f19c
#define ICON_FA6_BUILDING_FLAG "\xee\x93\x95"	// U+e4d5
#define ICON_FA6_BUILDING_LOCK "\xee\x93\x96"	// U+e4d6
#define ICON_FA6_BUILDING_NGO "\xee\x93\x97"	// U+e4d7
#define ICON_FA6_BUILDING_SHIELD "\xee\x93\x98"	// U+e4d8
#define ICON_FA6_BUILDING_UN "\xee\x93\x99"	// U+e4d9
#define ICON_FA6_BUILDING_USER "\xee\x93\x9a"	// U+e4da
#define ICON_FA6_BUILDING_WHEAT "\xee\x93\x9b"	// U+e4db
#define ICON_FA6_CITY "\xef\x99\x8f"	// U+f64f
#define ICON_FA6_MAGNIFYING_GLASS "\xef\x80\x82"	// U+f002
#define ICON_FA6_MAGNIFYING_GLASS_ARROW_RIGHT "\xee\x94\xa1"	// U+e521
#define ICON_FA6_MAGNIFYING_GLASS_CHART "\xee\x94\xa2"	// U+e522
#define ICON_FA6_MAGNIFYING_GLASS_DOLLAR "\xef\x9a\x88"	// U+f688
#define ICON_FA6_MAGNIFYING_GLASS_LOCATION "\xef\x9a\x89"	// U+f689
#define ICON_FA6_MAGNIFYING_GLASS_MINUS "\xef\x80\x90"	// U+f010
#define ICON_FA6_MAGNIFYING_GLASS_PLUS "\xef\x80\x8e"	// U+f00e
#define ICON_FA6_HANDS_CLAPPING "\xee\x86\xa8"	// U+e1a8
#define ICON_FA6_HANDS_HOLDING "\xee\x93\xb7"	// U+e4f7
#define ICON_FA6_HANDS_HOLDING_CHILD "\xee\x93\xba"	// U+e4fa
#define ICON_FA6_HANDS_HOLDING_CIRCLE "\xee\x93\xbb"	// U+e4fb
#define ICON_FA6_HAND_HOLDING_DROPLET "\xef\x92\xbb"	// U+f4bb
#define ICON_FA6_HAND_HOLDING_MEDICAL "\xee\x81\x9c"	// U+e05c
#define ICON_FA6_HAND_HOLDING_WATER "\xef\x93\x81"	// U+f4c1
#define ICON_FA6_HANDSHAKE_SIMPLE "\xee\x86\xae"	// U+e1ae
#define ICON_FA6_HANDSHAKE_SIMPLE_SLASH "\xee\x86\xaf"	// U+e1af
#define ICON_FA6_HANDS_PRAYING "\xef\x9a\x84"	// U+f684
#define ICON_FA6_FILE_CIRCLE_CHECK "\xee\x96\xa0"	// U+e5a0
#define ICON_FA6_FILE_CIRCLE_EXCLAMATION "\xee\x93\xab"	// U+e4eb
#define ICON_FA6_FILE_CIRCLE_MINUS "\xee\x93\xad"	// U+e4ed
#define ICON_FA6_FILE_CIRCLE_PLUS "\xee\x92\x94"	// U+e494
#define ICON_FA6_FILE_CIRCLE_QUESTION "\xee\x93\xaf"	// U+e4ef
#define ICON_FA6_FILE_CIRCLE_XMARK "\xee\x96\xa1"	// U+e5a1
#define ICON_FA6_FILE_SHIELD "\xee\x93\xb0"	// U+e4f0
#define ICON_FA6_FILE_PEN "\xef\x8c\x9c"	// U+f31c
#define ICON_FA6_SHAPES "\xef\x98\x9f"	// U+f61f
#define ICON_FA6_CIRCLE_NODES "\xee\x93\xa2"	// U+e4e2
#define ICON_FA6_DIAGRAM_NEXT "\xee\x91\xb6"	// U+e476
#define ICON_FA6_DIAGRAM_PREDECESSOR "\xee\x91\xb7"	// U+e477
#define ICON_FA6_DIAGRAM_PROJECT "\xee\x91\xb8"	// U+e478
#define ICON_FA6_DIAGRAM_SUCCESSOR "\xee\x91\xba"	// U+e47a
#define ICON_FA6_NETWORK_WIRED "\xef\x9b\xbf"	// U+f6ff
#define ICON_FA6_SHARE_NODES "\xef\x87\xa0"	// U+f1e0
#define ICON_FA6_CLOCK_ROTATE_LEFT "\xef\x87\x9a"	// U+f1da
#define ICON_FA6_HOURGLASS "\xef\x89\x94"	// U+f254
#define ICON_FA6_HOURGLASS_END "\xef\x89\x93"	// U+f253
#define ICON_FA6_HOURGLASS_HALF "\xef\x89\x92"	// U+f252
#define ICON_FA6_HOURGLASS_START "\xef\x89\x91"	// U+f251
#define ICON_FA6_STOPWATCH_20 "\xee\x81\xaf"	// U+e06f
#define ICON_FA6_COMPUTER "\xee\x93\xa5"	// U+e4e5
#define ICON_FA6_HARD_DRIVE "\xef\x82\xa0"	// U+f0a0
#define ICON_FA6_FLOPPY_DISK "\xef\x83\x87"	// U+f0c7
#define ICON_FA6_MEMORY "\xef\x94\xb8"	// U+f538
#define ICON_FA6_MICROCHIP "\xef\x8b\x9b"	// U+f2db
#define ICON_FA6_SERVER "\xef\x88\xb3"	// U+f233
#define ICON_FA6_DISPLAY "\xee\x85\xa3"	// U+e163
#define ICON_FA6_KEYBOARD "\xef\x84\x9c"	// U+f11c
#define ICON_FA6_PRINT "\xef\x80\xaf"	// U+f02f
#define ICON_FA6_PLUG_CIRCLE_BOLT "\xee\x95\x9b"	// U+e55b
#define ICON_FA6_PLUG_CIRCLE_CHECK "\xee\x95\x9c"	// U+e55c
#define ICON_FA6_PLUG_CIRCLE_EXCLAMATION "\xee\x95\x9d"	// U+e55d
#define ICON_FA6_PLUG_CIRCLE_MINUS "\xee\x95\x9e"	// U+e55e
#define ICON_FA6_PLUG_CIRCLE_PLUS "\xee\x95\x9f"	// U+e55f
#define ICON_FA6_PLUG_CIRCLE_XMARK "\xee\x95\xa0"	// U+e560
#define ICON_FA6_BOWL_FOOD "\xee\x93\x86"	// U+e4c6
#define ICON_FA6_BOWL_RICE "\xee\x93\x87"	// U+e4c7
#define ICON_FA6_BURGER "\xef\xa0\x85"	// U+f805
#define ICON_FA6_JAR "\xee\x94\x96"	// U+e516
#define ICON_FA6_JAR_WHEAT "\xee\x94\x97"	// U+e517
#define ICON_FA6_KITCHEN_SET "\xee\x94\x9a"	// U+e51a
#define ICON_FA6_WHEAT_AWN "\xee\x8b\x8d"	// U+e2cd
#define ICON_FA6_WHEAT_AWN_CIRCLE_EXCLAMATION "\xee\x96\x98"	// U+e598
#define ICON_FA6_BOTTLE_DROPLET "\xee\x93\x84"	// U+e4c4
#define ICON_FA6_BOTTLE_WATER "\xee\x93\x85"	// U+e4c5
#define ICON_FA6_LOCK_OPEN "\xef\x8f\x81"	// U+f3c1
#define ICON_FA6_LOCK_HASHTAG "\xee\x94\x9f"	// U+e51f
#define ICON_FA6_SHIELD_HALVED "\xef\x8f\xad"	// U+f3ed
#define ICON_FA6_SHIELD_HEART "\xee\x95\xb4"	// U+e574
#define ICON_FA6_SHIELD_VIRUS "\xee\x81\xac"	// U+e06c
#define ICON_FA6_USER_SHIELD "\xef\x94\x85"	// U+f505
#define ICON_FA6_USER_LOCK "\xef\x94\x82"	// U+f502
#define ICON_FA6_WALKIE_TALKIE "\xef\xa3\xaf"	// U+f8ef
#define ICON_FA6_TOWER_BROADCAST "\xef\x94\x99"	// U+f519
#define ICON_FA6_TOWER_CELL "\xee\x96\x85"	// U+e585
#define ICON_FA6_TOWER_OBSERVATION "\xee\x96\x86"	// U+e586
#define ICON_FA6_SATELLITE "\xef\x9e\xbf"	// U+f7bf
#define ICON_FA6_SATELLITE_DISH "\xef\x9f\x80"	// U+f7c0
#define ICON_FA6_TRIANGLE_EXCLAMATION "\xef\x81\xb1"	// U+f071
#define ICON_FA6_CIRCLE_EXCLAMATION "\xef\x81\xaa"	// U+f06a
#define ICON_FA6_CIRCLE_XMARK "\xef\x81\x97"	// U+f057
#define ICON_FA6_CIRCLE_CHECK "\xef\x81\x98"	// U+f058
#define ICON_FA6_CIRCLE_INFO "\xef\x81\x9a"	// U+f05a
#define ICON_FA6_CIRCLE_QUESTION "\xef\x81\x99"	// U+f059
#define ICON_FA6_CIRCLE_MINUS "\xef\x81\x96"	// U+f056
#define ICON_FA6_CIRCLE_PLUS "\xef\x81\x95"	// U+f055
#define ICON_FA6_CIRCLE_PAUSE "\xef\x8a\x8b"	// U+f28b
#define ICON_FA6_CIRCLE_PLAY "\xef\x85\x84"	// U+f144
#define ICON_FA6_CIRCLE_STOP "\xef\x8a\x8d"	// U+f28d
#define ICON_FA6_CIRCLE_DOT "\xef\x86\x92"	// U+f192
#define ICON_FA6_CIRCLE_HALF_STROKE "\xef\x81\x82"	// U+f042
#define ICON_FA6_CIRCLE_RADIATION "\xee\x92\x89"	// U+e489
#define ICON_FA6_CIRCLE_RIGHT "\xef\x8d\x9a"	// U+f35a
#define ICON_FA6_CIRCLE_LEFT "\xef\x8d\x99"	// U+f359
#define ICON_FA6_CIRCLE_UP "\xef\x8d\x9b"	// U+f35b
#define ICON_FA6_CIRCLE_DOWN "\xef\x8d\x98"	// U+f358
#define ICON_FA6_CIRCLE_USER "\xef\x8a\xbd"	// U+f2bd
#define ICON_FA6_CIRCLE_NOTCH "\xef\x87\x8e"	// U+f1ce
#define ICON_FA6_CIRCLE_H "\xef\x91\xbe"	// U+f47e
#define ICON_FA6_XMARK "\xef\x80\x8d"	// U+f00d
#define ICON_FA6_XMARK_LARGE "\xee\x96\x9b"	// U+e59b
#define ICON_FA6_X "\x58"	// U+0058
#define ICON_FA6_CHEVRON_LEFT "\xef\x81\x93"	// U+f053
#define ICON_FA6_CHEVRON_RIGHT "\xef\x81\x94"	// U+f054
#define ICON_FA6_CHEVRON_UP "\xef\x81\xb7"	// U+f077
#define ICON_FA6_CHEVRON_DOWN "\xef\x81\xb8"	// U+f078
#define ICON_FA6_ANGLES_LEFT "\xef\x84\x80"	// U+f100
#define ICON_FA6_ANGLES_RIGHT "\xef\x84\x81"	// U+f101
#define ICON_FA6_ANGLES_UP "\xef\x84\x82"	// U+f102
#define ICON_FA6_ANGLES_DOWN "\xef\x84\x83"	// U+f103
#define ICON_FA6_DICE "\xef\x94\xa2"	// U+f522
#define ICON_FA6_DICE_D4 "\xef\x9b\x90"	// U+f6d0
#define ICON_FA6_DICE_D6 "\xef\x94\xa3"	// U+f523
#define ICON_FA6_DICE_D8 "\xef\x9b\x92"	// U+f6d2
#define ICON_FA6_DICE_D10 "\xef\x9b\x93"	// U+f6d3
#define ICON_FA6_DICE_D12 "\xef\x9b\x94"	// U+f6d4
#define ICON_FA6_DICE_D20 "\xef\x9b\x8f"	// U+f6cf
#define ICON_FA6_CHESS "\xef\x90\xb9"	// U+f439
#define ICON_FA6_CHESS_BISHOP "\xef\x90\xba"	// U+f43a
#define ICON_FA6_CHESS_BOARD "\xef\x90\xbc"	// U+f43c
#define ICON_FA6_CHESS_KING "\xef\x90\xbf"	// U+f43f
#define ICON_FA6_CHESS_KNIGHT "\xef\x91\x81"	// U+f441
#define ICON_FA6_CHESS_PAWN "\xef\x91\x83"	// U+f443
#define ICON_FA6_CHESS_QUEEN "\xef\x91\x85"	// U+f445
#define ICON_FA6_CHESS_ROOK "\xef\x91\x87"	// U+f447
#define ICON_FA6_GAMEPAD "\xef\x84\x9b"	// U+f11b
#define ICON_FA6_PUZZLE_PIECE "\xef\x84\xae"	// U+f12e
#define ICON_FA6_SYRINGE "\xef\x92\x8e"	// U+f48e
#define ICON_FA6_VIAL "\xef\x92\x92"	// U+f492
#define ICON_FA6_VIAL_CIRCLE_CHECK "\xee\x96\x96"	// U+e596
#define ICON_FA6_VIAL_VIRUS "\xee\x96\x97"	// U+e597
#define ICON_FA6_VIALS "\xef\x92\x93"	// U+f493
#define ICON_FA6_PILLS "\xef\x92\x84"	// U+f484
#define ICON_FA6_CAPSULES "\xef\x91\xab"	// U+f46b
#define ICON_FA6_TABLETS "\xef\x92\x90"	// U+f490
#define ICON_FA6_STETHOSCOPE "\xef\x83\xb1"	// U+f0f1
#define ICON_FA6_HOSPITAL "\xef\x83\xb8"	// U+f0f8
#define ICON_FA6_HOSPITAL_USER "\xef\xa0\x8d"	// U+f80d
#define ICON_FA6_HEART_PULSE "\xef\x88\x9e"	// U+f21e
#define ICON_FA6_HEART_CRACK "\xee\x86\xbe"	// U+e1be
#define ICON_FA6_HEART_CIRCLE_BOLT "\xee\x93\xbe"	// U+e4fe
#define ICON_FA6_HEART_CIRCLE_CHECK "\xee\x93\xbf"	// U+e4ff
#define ICON_FA6_HEART_CIRCLE_EXCLAMATION "\xee\x94\x80"	// U+e500
#define ICON_FA6_HEART_CIRCLE_MINUS "\xee\x94\x81"	// U+e501
#define ICON_FA6_HEART_CIRCLE_PLUS "\xee\x94\x82"	// U+e502
#define ICON_FA6_HEART_CIRCLE_XMARK "\xee\x94\x83"	// U+e503
#define ICON_FA6_CLOUD_SUN "\xef\x9b\x84"	// U+f6c4
#define ICON_FA6_CLOUD_MOON "\xef\x9b\x83"	// U+f6c3
#define ICON_FA6_CLOUD_RAIN "\xef\x9c\xbd"	// U+f73d
#define ICON_FA6_CLOUD_SHOWERS_HEAVY "\xef\x9d\x80"	// U+f740
#define ICON_FA6_CLOUD_BOLT "\xef\x9d\xac"	// U+f76c
#define ICON_FA6_CLOUD_ARROW_UP "\xef\x83\xae"	// U+f0ee
#define ICON_FA6_CLOUD_ARROW_DOWN "\xef\x83\xad"	// U+f0ed
#define ICON_FA6_SUN "\xef\x86\x85"	// U+f185
#define ICON_FA6_MOON "\xef\x86\x86"	// U+f186
#define ICON_FA6_RAINBOW "\xef\x9d\x9b"	// U+f75b
#define ICON_FA6_SNOWFLAKE "\xef\x8b\x9c"	// U+f2dc
#define ICON_FA6_TEMPERATURE_HALF "\xef\x8b\x89"	// U+f2c9
#define ICON_FA6_TEMPERATURE_FULL "\xef\x8b\x87"	// U+f2c7
#define ICON_FA6_TEMPERATURE_EMPTY "\xef\x8b\x8b"	// U+f2cb
#define ICON_FA6_TEMPERATURE_HIGH "\xef\x9d\xa9"	// U+f769
#define ICON_FA6_TEMPERATURE_LOW "\xef\x9d\xab"	// U+f76b
#define ICON_FA6_CAR_SIDE "\xef\x97\xa4"	// U+f5e4
#define ICON_FA6_CAR_REAR "\xef\x97\x9e"	// U+f5de
#define ICON_FA6_CAR_BURST "\xee\x93\x8b"	// U+e4cb
#define ICON_FA6_CAR_ON "\xee\x93\x9d"	// U+e4dd
#define ICON_FA6_TRUCK "\xef\x83\x91"	// U+f0d1
#define ICON_FA6_TRUCK_MEDICAL "\xef\x83\xb9"	// U+f0f9
#define ICON_FA6_TRUCK_PLANE "\xee\x96\x8f"	// U+e58f
#define ICON_FA6_TRUCK_RAMP_BOX "\xef\x93\x9e"	// U+f4de
#define ICON_FA6_HELICOPTER "\xef\x94\xb3"	// U+f533
#define ICON_FA6_HELICOPTER_SYMBOL "\xee\x94\x82"	// U+e502
#define ICON_FA6_PLANE "\xef\x81\xb2"	// U+f072
#define ICON_FA6_PLANE_UP "\xee\x88\xad"	// U+e22d
#define ICON_FA6_PLANE_CIRCLE_CHECK "\xee\x95\x95"	// U+e555
#define ICON_FA6_PLANE_CIRCLE_EXCLAMATION "\xee\x95\x96"	// U+e556
#define ICON_FA6_PLANE_CIRCLE_XMARK "\xee\x95\x97"	// U+e557
#define ICON_FA6_PLANE_DEPARTURE "\xef\x96\xb0"	// U+f5b0
#define ICON_FA6_PLANE_ARRIVAL "\xef\x96\xaf"	// U+f5af
#define ICON_FA6_PLANE_SLASH "\xee\x81\xa9"	// U+e069
#define ICON_FA6_SHIP "\xef\x88\x9a"	// U+f21a
#define ICON_FA6_FERRY "\xee\x93\xaa"	// U+e4ea
#define ICON_FA6_TRACTOR "\xef\x9c\xa2"	// U+f722
#define ICON_FA6_BICYCLE "\xef\x88\x86"	// U+f206
#define ICON_FA6_MOTORCYCLE "\xef\x88\x9c"	// U+f21c
#define ICON_FA6_TRAIN "\xef\x88\xb8"	// U+f238
#define ICON_FA6_BUS "\xef\x88\x87"	// U+f207
#define ICON_FA6_ROCKET "\xef\x84\xb5"	// U+f135
#define ICON_FA6_SHARE_FROM_SQUARE "\xef\x85\x8d"	// U+f14d
#define ICON_FA6_SQUARE_SHARE_NODES "\xef\x87\xa1"	// U+f1e1
#define ICON_FA6_THUMBS_UP "\xef\x85\xa4"	// U+f164
#define ICON_FA6_THUMBS_DOWN "\xef\x85\xa5"	// U+f165
#define ICON_FA6_COMMENT "\xef\x81\xb5"	// U+f075
#define ICON_FA6_COMMENTS "\xef\x82\x86"	// U+f086
#define ICON_FA6_COMMENT_DOTS "\xef\x92\xad"	// U+f4ad
#define ICON_FA6_COMMENT_SMS "\xef\x9f\x8d"	// U+f7cd
#define ICON_FA6_FLAG "\xef\x80\xa4"	// U+f024
#define ICON_FA6_FLAG_CHECKERED "\xef\x84\x9e"	// U+f11e
#define ICON_FA6_FLAG_USA "\xef\x9d\x8d"	// U+f74d

// ─── FA6 Extra: Tools / Construction ────────────────────────────────────────
#define ICON_FA6_PICKAXE        "\xee\x96\xbf"  // U+e5bf  (FA6 Classic Solid)
#define ICON_FA6_SHOVEL         "\xef\x96\xb3"  // U+f693
#define ICON_FA6_AXE            "\xef\xa0\x91"  // U+f801
#define ICON_FA6_HAMMER         "\xef\x9f\xbc"  // U+f7fc
#define ICON_FA6_SCREWDRIVER    "\xef\x97\xbc"  // U+f5fc
#define ICON_FA6_SCREWDRIVER_WRENCH "\xef\x91\xb5" // U+f4c5 (tools)
#define ICON_FA6_TROWEL         "\xee\x96\x91"  // U+e591
#define ICON_FA6_TROWEL_BRICKS  "\xee\x96\x92"  // U+e592
#define ICON_FA6_RULER          "\xef\x97\xbe"  // U+f5fe
#define ICON_FA6_RULER_COMBINED "\xef\x97\xbf"  // U+f5ff
#define ICON_FA6_RULER_HORIZONTAL "\xef\x98\x80" // U+f600
#define ICON_FA6_RULER_VERTICAL   "\xef\x98\x81" // U+f601
#define ICON_FA6_HELMET_SAFETY  "\xef\xa0\xbf"  // U+f807  (hard-hat)
#define ICON_FA6_HELMET_UN      "\xee\x92\x8f"  // U+e48f
#define ICON_FA6_VEST           "\xee\x90\xbf"  // U+e43f
#define ICON_FA6_VEST_PATCHES   "\xee\x91\x80"  // U+e440
#define ICON_FA6_BORE_HOLE      "\xee\x91\xa6"  // U+e4c6 (not food bowl - drilling)
